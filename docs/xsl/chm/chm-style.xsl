...
<!--    <xsl:param name="htmlhelp.show.advanced.search" select="1"/>-->
    ...
    <xsl:param name="htmlhelp.chm">json-schema-php.chm</xsl:param>
...
<!--
    ...
    <xsl:param name="highlight.xslthl.config">file:///D:/Project/Netbeans/Java/JSON-Schema-PHP/docs/temp/docbook-xsl/highlighting/xslthl-config.xml</xsl:param>
