...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- Use nice graphics for admonitions -->
    ...
    <xsl:param name="admon.graphics.path">docs/books/json-schema-php/images/</xsl:param>
    <xsl:param name="draft.watermark.image" select="'docs/books/json-schema-php/images/draft.png'"/>
